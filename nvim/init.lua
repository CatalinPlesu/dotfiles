...
-- handle tabs and space, the best way possible
vim.opt.tabstop = 4
		...
		opts = {
			config = function()
				require("nvim-treesitter.configs").setup({
					ensure_installed = { "lua", "vim", "c", "python" }, -- Add languages you need
...
-- Re-map 's' and 'S' to their default substitution commands
